...
OID_CISCO_HOSTNAME_DEFAULT = "1.3.6.1.2.1.1.5.0"
...
def get_dvc_info_cisco_c3560(ip,community_string): # --> get model and version for cisco C3560 Switches
    ...
    # --> get hostname
    dvc_hostname = snmpdvcinfo.get_snmp(ip, [OID_CISCO_HOSTNAME_SW_C3560], community_string)
...
def get_dvc_info_cisco_c2960c(ip,community_string):
    ...
    # --> get hostname
    dvc_hostname = snmpdvcinfo.get_snmp(ip, [OID_CISCO_HOSTNAME_SW_C2960C], community_string)
